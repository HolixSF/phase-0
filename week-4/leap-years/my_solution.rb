	...
	if year % 4 == 0 			# WILL RETURN TRUE IF DIVISIBLE BY 4			
    		if year % 100 == 0 		# IF IT IS DIVISIBLE BY 100 WILL RETURN FALSE
    			if year % 400 == 0 	# ONLY IF IT IS DIVISIBLE BY 400 WILL IT RETURN TRUE
            		return true		# SO IF IT IS NOT DIVISIBLE BY 400 IT WILL RETURN FALSE
         		end			# MAKING THE ARGUMENT OF 100 ABOVE TRUE THEREFORE 4 AND 100 IS TRUE WHILE 400 IS FALSE
         	return false
      		end
      	return true
